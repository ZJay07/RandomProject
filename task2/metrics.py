...
def evaluate_metrics(model, test_loader, device, num_classes=10):
    ...
    macro_f1 = 100 * compute_f1_score(all_targets, all_preds, num_classes=num_classes, average='macro')
    
    # Calculate confusion matrix
    conf_matrix = compute_confusion_matrix(all_targets, all_preds, num_classes=num_classes)
