...
def experiment_regularization_methods(num_feature_maps = 128, std_dev = 0.01, kernel_size=7, lr = 0.1, epoch=50, num_ensemble_models = 10, save_path="./task2"):
...
if __name__ == "__main__":
    ...
    # TODO: Use these parameters (feature_maps = 128, std_dev = 0.01, kernel_size=7, lr = 0.1, epoch=50)
